# DisplayName: Jolla i9100/@ARCH@ (release) 1
...
repo --name=adaptation-common-i9100-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-i9100-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/i9100
